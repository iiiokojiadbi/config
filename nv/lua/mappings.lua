...
M.general = function()
  ...
  map("n", "<C-n>", "<cmd>noh<CR>", "general выключить подсветку поиска")
  ...
  map("n", "<C-s>", "<cmd>update<CR>", "general сохранить файл")
  map("n", "<C-c>", "<cmd>%y+<CR>", "general копировать весь файл")
  -- map("n", "<Tab>", "<cmd>bnext<CR>", "general следующий буфер")
  -- map("n", "<s-Tab>", "<cmd>bprev<CR>", "general предыдущий буфер")
  ...
  map("n", "<C-d>", "<C-d>zz", "general вертикальный скролл вниз и центрирование")
  map("n", "<C-u>", "<C-u>zz", "general вертикальный скролл вверх и центрирование")

  map("n", "n", "nzzzv", "search найти и центрировать")
  map("n", "N", "Nzzzv", "search найти и центрировать")

  map("v", "??", 'y:h <C-R>"<cr>"', "показать vim help") --
